...
<head>
    ...
    <title>Login Page | MUMBRA BAKERY</title>
...
<body class="container-fluid"  style="background-color:SlateBlue">
    <header>
    <div class="container-fluid text-center">
        <nav class="navbar navbar-expand-md navbar-dark sticky-top">
            ...
            <div class="collapse navbar-collapse" id="collapse_target">
                ...
                <span class="navbar-text" id="nvtxt"><b>MUMBRA BAKERY</b></span>
                <ul class="navbar-nav ml-auto">
                    <div class="btn btn-info">
                        <li class="nav-item dropdown">
                        <a class="btn btn-info" href="index.html">Home</a>
                        <a class="btn btn-info" href="products.html">Our Products</a>
                        <a class="btn btn-info" href="order.php">Order Cakes</a>
                        <a class="btn btn-info" href="login.php"">Customer Login</a>
                        <a class="btn btn-info" href="admin.php""> Admin</a>
                        <a class="btn btn-info" href="about.html">About Us</a>
                        <a class="btn btn-info" href="contact.html">Contact</a>
                        </li>
                    </div>
...
?>
    ...
    <div class="footer-copyright text-center py-3">© 2020 Copyright:
      <a href="https://www.mumbrabakery.tk"> www.mumbrabakery.tk</a>
    </div>
    </footer>
</body>
</html>